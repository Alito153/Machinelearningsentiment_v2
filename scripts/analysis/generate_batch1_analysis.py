...
batch_stats = {
    ...
    'out_of_sample_sharpe': {
        'mean': np.mean(out_of_sample_sharpes),
        'median': np.median(out_of_sample_sharpes),
        'std': np.std(out_of_sample_sharpes),
        'min': np.min(out_of_sample_sharpes),
        'max': np.max(out_of_sample_sharpes),
        'range': [np.min(out_of_sample_sharpes), np.max(out_of_sample_sharpes)]
    },
    'in_sample_sharpe': {
        'mean': np.mean(in_sample_sharpes),
        'median': np.median(in_sample_sharpes),
    ...
    'out_of_sample_win_rate': {
        'mean': np.mean(out_of_sample_win_rates),
        'min': np.min(out_of_sample_win_rates),
        'max': np.max(out_of_sample_win_rates)
    },
    'out_of_sample_profit_factor': {
        'mean': np.mean(out_of_sample_profit_factors),
        'min': np.min(out_of_sample_profit_factors),
        'max': np.max(out_of_sample_profit_factors)
    },
    'performance_improvement': {
        'vs_baseline_sharpe_percent': ((np.mean(out_of_sample_sharpes) - baseline_sharpe) / baseline_sharpe) * 100,
        'vs_baseline_sharpe_absolute': np.mean(out_of_sample_sharpes) - baseline_sharpe,
        'periods_beat_baseline': sum(1 for s in out_of_sample_sharpes if s > baseline_sharpe)
    }
}
