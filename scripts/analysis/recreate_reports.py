...
with open('/app/forex_macro_sentiment_1329/analysis/leakage_analysis_report.txt', 'w') as f:
    f.write(leakage_report)

print("✓ Leakage analysis report created")
print(f"✓ File size: {len(leakage_report)} characters")